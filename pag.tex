...
%-------------------------------------------------------
   \minipage[c][0.7\textheight][s]{\textwidth}
         ...
         \only<1>{
         Their behavior is modeled through a utility function, which considers: 
         \begin{itemize}
...
\begin{frame}{Key ideas of PAG 3/3}{Verifications and privacy}
%-------------------------------------------------------
      \begin{center}
         \includegraphics[width=.8\textwidth]<1>{fig/pag_example/1.pdf}
         \includegraphics[width=.8\textwidth]<2>{fig/pag_example/2.pdf}
         \includegraphics[width=.8\textwidth]<3>{fig/pag_example/3.pdf}
         \includegraphics[width=.8\textwidth]<4>{fig/pag_example/4.pdf}
         \includegraphics[width=.8\textwidth]<5>{fig/pag_example/5.pdf}
         \includegraphics[width=.8\textwidth]<6>{fig/pag_example/6.pdf}
         \includegraphics[width=.8\textwidth]<7>{fig/pag_example/7.pdf}
         \includegraphics[width=.8\textwidth]<8>{fig/pag_example/8.pdf}
         \includegraphics[width=.8\textwidth]<9>{fig/pag_example/9.pdf}
         \includegraphics[width=.8\textwidth]<10>{fig/pag_example/10.pdf}
         \includegraphics[width=.8\textwidth]<11>{fig/pag_example/11.pdf}
         \includegraphics[width=.8\textwidth]<12>{fig/pag_example/12.pdf}
         \includegraphics[width=.8\textwidth]<13>{fig/pag_example/13.pdf}
         \includegraphics[width=.8\textwidth]<14>{fig/pag_example/14.pdf}
         \includegraphics[width=.8\textwidth]<15>{fig/pag_example/15.pdf}
         \includegraphics[width=.8\textwidth]<16>{fig/pag_example/16.pdf}
         \includegraphics[width=.8\textwidth]<17>{fig/pag_example/17.pdf}
      \end{center}
\end{frame}
